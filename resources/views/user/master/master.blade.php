...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('site/assets/css/style-user.css') }}">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto my-auto main_menu">
                    <li class="nav-item mr-4">
                        <a class="nav-link icon-tachometer" href="">
                            Perfil do Cliente
                            <span class="sr-only">(current)</span>
                        </a>
                    </li>
                    <li class="nav-item dropdown mr-4 sub_menu">
                        <a class="nav-link dropdown-toggle icon-tasks" href="#" id="navbarDropdown" role="button"
                           data-toggle="dropdown" aria-expanded="false">
                            Atividades/Tarefas
                        </a>
                        <div class="dropdown-menu mt-lg-2" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item icon-search" href="#">Nenhuma Atividade Registrada</a>
                ...
                <li class="nav-item dropdown d-flex ">
                    ...
                    <div class="dropdown-menu exit mt-lg-2 w-25" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item icon-sign-out" href="{{ route('user.logout') }}">Sair</a>
                    </div>
                </li>
            </div>
        </nav>
